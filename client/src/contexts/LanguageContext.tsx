...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "how.3.title": "AI Performance Analysis",
    "how.3.desc": "Our AI engine analyzes physical attributes, movement patterns, and sport-specific performance indicators.",
  ...
  ar: {
    ...
    "how.3.title": "تحليل الأداء بالذكاء الاصطناعي",
    "how.3.desc": "محرك الذكاء الاصطناعي يحلل الخصائص الجسدية وأنماط الحركة ومؤشرات الأداء لكل رياضة.",
