...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "how.1.title": "Create Sports Identity",
    "how.1.desc": "Every athlete receives a sports passport containing all their certificates and performance evaluation.",
    "how.2.title": "Upload Sports Media",
    "how.2.desc": "Upload a photo or video of any athlete. No special equipment needed — a smartphone is enough.",
    "how.3.title": "AI Analyzes Performance",
    "how.3.desc": "Our AI engine analyzes physical attributes, movement patterns, and sport-specific indicators.",
  ...
  ar: {
    ...
    "how.1.title": "إنشاء هوية رياضية",
    "how.1.desc": "يحصل كل رياضي على جواز رياضي يحمل جميع شهاداته وتقييم أدائه.",
    "how.2.title": "رفع وسط رياضي",
    "how.2.desc": "ارفع صورة أو فيديو لأي رياضي. لا تحتاج معدات خاصة — الهاتف الذكي كافٍ.",
    "how.3.title": "الذكاء الرياضي يحلل الأداء",
    "how.3.desc": "يحلل محرك الذكاء الاصطناعي الخصائص الجسدية وأنماط الحركة والمؤشرات الخاصة بكل رياضة.",
